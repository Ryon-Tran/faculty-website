  ...
  return (
    <div className="flex flex-col items-start w-full font-['Inter']">
      ...
      <div className="flex h-[300px] items-center justify-center relative w-full bg-[#1a428a]">
        <p className="font-extrabold text-[42px] text-center text-white uppercase relative">Khoa & Bộ môn</p>
      </div>

      <div className="flex flex-col gap-[64px] items-start px-[80px] py-[64px] w-full md:px-[20px] lg:px-[80px]">
